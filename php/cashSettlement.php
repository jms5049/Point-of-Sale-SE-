...
<head>
    ...
    <script src="../js/settlement.js?version=2"></script>
</head>
<script>
...
//            $currentTotalCash = $result['cash'];
//            $sql = "UPDATE balance SET total = total + ".$finalPrice." WHERE total =".$currentTotalBalance;
//            mysqli_query($mysql, $sql);
//            //  현금 잔고 업데이트
//            $sql = "UPDATE balance SET cash = cash + ".$finalPrice." WHERE cash =".$currentTotalCash;
//            mysqli_query($mysql, $sql);
//
...
//
//        ?>
//        location.href ="/pos4/php/initial.php";
//    }
    ...
    function onSubmitForm()
    {
        ...
        {
            document.purchaseForm.action ="cashSuccess.php";
        }
...
<div class="w3-container" id="box">
    ...
    <table>
        ...
        <tr>
            <td>최종금액</td>
            <?php
            echo " <td id='totalPrice'>$finalPrice 원</td> ";?>
...
<!--        <button onclick="PurchaseFailure()" >취소</button><button onclick="cashPurchaseComplete()">완료</button>-->
    </div>
</div>
