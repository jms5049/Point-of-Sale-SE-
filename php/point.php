...
<div>
    ...
    <button type="button" id="confirmPointUseButton" onclick="confirmUse()">확인</button>
</div>
...
<script type="text/javascript">
    ...
    function confirmUse(){
        ...
        window.opener.parent.document.getElementsByClassName("price")[1].innerHTML = document.getElementById("pointUse").value;
        window.opener.parent.document.getElementsByName("pointUse")[0].value = document.getElementById("pointUse").value;
        window.opener.parent.document.getElementsByName("pointUse")[0].onchange();
